...
const Home = () => {
  ...
  {new Array(8).fill(0).map((_, index) => (
    <Link key={index} to="/reviews" style={{ textDecoration: 'none' }}>
      <BlogCard
        image="https://images.unsplash.com/photo-1511193311914-0346f16efe90?q=80&w=2073&auto=format&fit=crop"
        category="Gaming"
        title="The Ultimate Beginner's Guide to Playing Blackjack"
      ...
      />
        ...
        <div className="home-cta-section">
          <div className="home-cta-content">
            ...
            <h1 className="home-cta-title">Make $499 - $1000 Weekly<br />
              Use Data not Luck</h1>

            <div className="home-cta-form">
              <input className="home-cta-input" placeholder="Enter your email" />
